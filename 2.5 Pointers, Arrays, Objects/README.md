# Lab 7: Pointers, Arrays, Objects

## Problem 1: Circle Area and Circumference
...
function. Then print the calculated area and circumference for each circle. The program should only terminate
if one or more of the input radii are negative (while loop!).
