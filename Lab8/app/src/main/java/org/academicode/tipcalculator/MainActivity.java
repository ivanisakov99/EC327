...
public class MainActivity extends Activity implements OnClickListener {
    ...
    /*
     * An onCreate method/function is what is called when a screen is first
     * showed. In this case, this is the main menu screen.
     */
    @Override
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        // How the activity actually looks is inside main.xml, inside the layout
        // folder
        ...
        /*
         * The buttons now have onClickListeners set, a method/function of the
    ...
    /*
     * onClick is what is called when the buttons are pressed and they take in
     * Views as arguments as buttons are children of the view class, buttons can
     * polymorphically be passed in. The button that called the onClick is
    ...
    public void onClick(final View v) {
        ...
        if ("".equals(text)) {
            // Show a toast telling them they need to enter a value. Text is
            // pulled from strings.xml
            Toast.makeText(MainActivity.this, getResources().getString(R.string.error_et), Toast.LENGTH_LONG).show();
            // Breaks out of the onClick, as we do not want to launch a new
            // Activity without entered values
            return;
        }

        /*
         * If all is good, launch a new activity that passes in the amount
         * entered and tip percentage NOTE: Double.parseDouble(string) turns a
         * string into a double. It is used to cast the user's input to a double
         * and feed it into the new activity
         */
        launchResultActivity(Double.parseDouble(et.getText().toString()), tipPercent);
    }

    /*
     * The launchResultActivity method is used to start a new activity from
     * within an onClickListener
     */
    private void launchResultActivity(final double total, final double tipPercent) {
        double tip = total * tipPercent;
        double grandTotal = total + tip;

        /*
         * The intent class represents an action is used to "load" activities
         * into a variable so they can be passed in and launched from the
         * startActivity method. Basic intents take two arguments, the current
         * class(.java) and the class(.java) that the app will move to The line
         * below initializes an Intent named resultActivity and passes in
         * (Main.this,Result.class) much like the this-> pointer in C++, the
         * this keyword in java is used by classes to reference themselves
         */
        Intent resultActivity = new Intent(MainActivity.this, Result.class);

        /*
         * Since this method is private, if we want the Result Activity/class to
         * access it's members (the strings TAG_TIP and TAG_GRAND_TOTAL), we can
         * "push" members from the Main Acivity/class to Result, much like how a
         * friend function can "pull" private members from objects
         */
