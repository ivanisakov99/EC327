...
Write a C++ program ([`Q2.cpp`](./question2/Q2.cpp)) that takes simple, one operand arithmetic operations from
the command line and calculates the result. The program should accept signed integers as operands, and support
the `*`, `/`, `+`, `-` operators. When provided to the command line, operands and operators should be separated
