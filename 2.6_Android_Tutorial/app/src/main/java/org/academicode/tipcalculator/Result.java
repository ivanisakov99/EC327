...
public class Result extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        /*
         * Set the texts views so they display according to the parameters in
         * result.xml
         */
        tipTextView = (TextView) findViewById(R.id.tip);
        totalTextView = (TextView) findViewById(R.id.total);

        // Runs the method to use the values calculated in the Main Activity
        // class
        initializeTextViews();
        ...
        finished.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                // Finish ends the current activity and goes back to the
                // activity that called this one (Main in this case)
                finish();
            }
        });
    }
